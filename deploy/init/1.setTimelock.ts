...
const setTimelock: DeployFunction = async () => {
  /* Run via: npx hardhat run deploy/init/1.setTimelock.ts --network <network> */
};
setTimelock.tags = ["init", "setTimelock"];
setTimelock.id = "setTimelock";
