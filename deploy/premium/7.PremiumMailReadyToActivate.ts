...
const deploy: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const data = await deploy("PremiumMailReadyToActivate", {
    from: deployer,
    args: [],
    log: true,
  ...
  console.log("PremiumMailReadyToActivate deployed to:", data.address);
...
deploy.tags = ["PremiumMailReadyToActivate"];
